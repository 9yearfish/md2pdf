...
const ko: Messages = {
  ...
  about: {
    ...
    faq: [
      {
        ...
        answer: [
          '아니요. 파싱, 조판, PDF 생성은 모두 브라우저 안에서 이루어집니다. 텍스트, 이미지, PDF는 기기 밖으로 나가지 않습니다. 이 사이트의 콘텐츠 보안 정책(CSP)은 사이트 자신과 Cloudflare의 익명 방문 통계(쿠키 없음, 페이지 방문만 기록하며 문서 내용은 받지 않음)로만 연결을 허용하고, 그 밖의 모든 주소는 브라우저가 차단합니다.',
        ],
      },
      {
    ...
    footer:
      `<strong class="colophon-mark"><span class="brand-free">free</span>md2pdf.com</strong> · 브라우저에서 Markdown을 PDF로 변환, Mermaid 다이어그램은 벡터 그대로. 문서는 업로드되지 않습니다.`,
    languagesHeading: '언어',
  },
